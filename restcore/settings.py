"""
Django settings for restcore project.
...
WSGI_APPLICATION = 'restcore.wsgi.application'
...
DATABASES = {  
    'default': {  
        ...
        'NAME': 'pricegram-beta-database-database',  
        'USER': 'kgaeiszluf',  
...
TREBLLE_HIDDEN_KEYS = ["email"]

TREBLLE_INFO = {
    'api_key': os.environ.get('986JNKsDDyBL6FyzClaeAdlgXqPyB9kq'),
    'project_id': os.environ.get('3kfahE9hCjywZpRH'),
